    ...
    <?php
     ...
     {  
        ...
        <tr>
            ...
            <td class="center aligned" ><div class="ui button" onclick="location.href = './CourseFrame?code=<?php echo $row1['code']  ?>'" >Frame Patten</div></td>
            ...
            <td class="center aligned" ><div class="ui button" onclick="location.href = '../Entity/Table'">Mark Entry</div></td>
        ...
        if($row1['staff1']==$_SESSION['staffid'] || $row1['staff2']==$_SESSION['staffid'] || $row1['staff3']==$_SESSION['staffid'] || $row1['staff4']==$_SESSION['staffid'])
        {
            ...
            <tr>
                ...
                <td class="center aligned" ><?php  echo $row1['batch']; ?> </td>
                <td class="center aligned" ><?php  echo $row1['sem'];   ?> </td>
                <td class="center aligned" colspan="4" > <div class="ui button"> Mark Entry</div> </td>
